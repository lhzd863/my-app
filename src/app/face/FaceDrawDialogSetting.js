...
class FaceDrawDialogSetting extends Component {
  ...
  static propTypes = {
    ...
    face_eye: PropTypes.number,
    faceEyeCreate: PropTypes.func,
    face_lip: PropTypes.number,
    faceLipCreate: PropTypes.func,
    face_eyebrow: PropTypes.number,
    faceEyeBrowCreate: PropTypes.func,
  }
}
const FaceDrawDialogSettingWrapper = createForm()(FaceDrawDialogSetting);
export default FaceDrawDialogSettingWrapper;
