...
class AppPolarCharts extends Component {
  ...
  render() {
    ...
    const ctitle0 = this.props.ctitle;
    ...
    return (
        <div>
              <MyHeader myheadertitle={ global.constants.const_app_chart_polar } />
              <WingBlank size="lg">
                  <WhiteSpace size="lg" />
...
const AppPolarChartsWrapper = createForm()(AppPolarCharts);
export default AppPolarChartsWrapper;
