...
class AppScatterCharts extends Component {
  ...
  handleClickSubmit (e) {
       ...
       for ( var i=0;i<arr.length;i++) {
           ...
           if(subarr.length>1&&IsNumberFunc(subarr[0].trim())&&IsNumberFunc(subarr[1].trim())){
               row = {};
  ...
  render() {
    ...
    return (
        <div>
              <MyHeader myheadertitle={ global.constants.const_app_chart_scatter } />
              <WingBlank size="lg">
                  <WhiteSpace size="lg" />
...
const AppScatterChartsWrapper = createForm()(AppScatterCharts);
export default AppScatterChartsWrapper;
