...
class AppBarCharts extends Component {
  ...
  render() {
    ...
    return (
        <div>
              <MyHeader myheadertitle={ global.constants.const_app_chart_bar } />
              <WingBlank size="lg">
                  <WhiteSpace size="lg" />
...
const AppBarChartsWrapper = createForm()(AppBarCharts);
export default AppBarChartsWrapper;
