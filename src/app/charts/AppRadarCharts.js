...
import ChartDialog05SettingContainers from '../../redux/containers/ChartDialog05SettingContainers.js';


class AppRadarCharts extends Component {
  ...
  constructor(props) {
      ...
      this.state = {xaxis: props.xaxis||['January', 'February', 'March', 'April', 'May', 'June', 'July'],
                    ...
                    chart_label: props.chart_label||'top',
  ...
  render() {
    ...
    const displayname = (this.props.display_name).toString();
    ...
    return (
        <div>
              <MyHeader myheadertitle={ global.constants.const_app_chart_radar } />
              <WingBlank size="lg">
                  <WhiteSpace size="lg" />
                  ...
                  <ReactMarkdown
                    ...
                    escapeHtml={false}
                  />
                 <ChartDialog05SettingContainers />
              </WingBlank>
        </div>
    );
  }
...
const AppRadarChartsWrapper = createForm()(AppRadarCharts);
export default AppRadarChartsWrapper;
