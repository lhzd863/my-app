...
class AppPieCharts extends Component {
  ...
  render() {
    ...
    return (
        <div>
              <MyHeader myheadertitle={ global.constants.const_app_chart_pie } />
              <WingBlank size="lg">
                  <WhiteSpace size="lg" />
...
const AppPieChartsWrapper = createForm()(AppPieCharts);
export default AppPieChartsWrapper;
