...
class ChirstmasHat extends Component {
    ...
    handleData() {
        ...
        this.props.displayConsoleCreate('none');
        let url = global.constants.const_api_url + "/app/face/chirstmas?accesstoken=" + accesstoken;
        fetch(url, {
            method: "Post",
            mode: "cors",
            headers: {
    ...
    render() {
        ...
        return (
            <div>
                <MyHeader myheadertitle={global.constants.const_app_chirstmas_hat} />
                <WingBlank size="lg">
                ...
                <WingBlank size="lg">
                    ...
                    <Upload
                        ...
                        action={global.constants.const_api_url + "/app/chirstmas?accesstoken=" + accesstoken}
...
const ChirstmasHatWrapper = createForm()(ChirstmasHat);
export default ChirstmasHatWrapper;
