...
class ChartDialog05Setting extends Component {

  constructor(props) {
      super(props);
      this.state = {
                    chart_label: props.chart_label||'label',
...
const ChartDialog05SettingWrapper = createForm()(ChartDialog05Setting);
export default ChartDialog05SettingWrapper;
