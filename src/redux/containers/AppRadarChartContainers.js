...
import AppRadarChartsWrapper from '../../app/charts/AppRadarCharts.js';
...
const AppRadarChartContainers = connect(
   mapStateToProps,
   mapDispatchToProps
)(AppRadarChartsWrapper);

export default AppRadarChartContainers;
