...
import AppFitLineChartsWrapper from '../../app/charts/AppFitLineCharts.js';
...
const AppFitLineChartContainers = connect(
   mapStateToProps,
   mapDispatchToProps
)(AppFitLineChartsWrapper);

export default AppFitLineChartContainers;
