...
import AppScatterChartsWrapper from '../../app/charts/AppScatterCharts.js';
...
const AppScatterChartContainers = connect(
   mapStateToProps,
   mapDispatchToProps
)(AppScatterChartsWrapper);

export default AppScatterChartContainers;
