...
import AppDoughnutChartsWrapper from '../../app/charts/AppDoughnutCharts.js';
...
const AppDoughnutChartContainers = connect(
   mapStateToProps,
   mapDispatchToProps
)(AppDoughnutChartsWrapper);

export default AppDoughnutChartContainers;
