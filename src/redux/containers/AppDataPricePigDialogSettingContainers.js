...
import AppDataPricePigDialogSettingWrapper from '../../app/price/AppDataPricePigDialogSetting.js';
...
const AppDataPricePigDialogSettingContainers = connect(
   mapStateToProps,
   mapDispatchToProps
)(AppDataPricePigDialogSettingWrapper);

export default AppDataPricePigDialogSettingContainers;
