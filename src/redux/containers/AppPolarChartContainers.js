...
import AppPolarChartsWrapper from '../../app/charts/AppPolarCharts.js';
...
const AppPolarChartContainers = connect(
   mapStateToProps,
   mapDispatchToProps
)(AppPolarChartsWrapper);

export default AppPolarChartContainers;
